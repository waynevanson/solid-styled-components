...
type StylesGenerator<P = {}> = (props: P) => CSSAttribute | string;
type TagStyleGenerator<P = {}> = (props: P) => number | string | undefined;
...
export declare function keyframes(tag: TemplateStringsArray, ...tagArgs: TagArgs): string;
export declare function extractCss(): string;
export declare function glob(styles: StylesArg): void;
export declare function glob(tag: TemplateStringsArray, ...tagArgs: TagArgs): void;
export declare function css(styles: StylesArg): string;
export declare function css(tag: TemplateStringsArray, ...tagArgs: TagArgs): string;
...
type StylesFn<T> = <P>(styles: StylesArg<P & T & AsProps & ThemeProp>) => Component<
  P & T & AsProps
> & {
